...
const timeline = [
  {
    step: "01",
    title: "Bootstrap",
    description: "从一个干净的 Next.js 模板起步，保留最核心的页面、组件、API 与工程能力。",
  },
  {
    step: "02",
    title: "Compose",
    description: "优先用 shadcn/ui 与项目已有封装拼出官网骨架，再做品牌化、动效和科技感强化。",
  },
  {
    step: "03",
    title: "Ship",
    description: "通过 post-receive、pnpm build 和 PM2 重启，把改动稳定发到云服务器与正式域名。",
  },
];
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <p className="max-w-2xl text-base leading-8 text-white/68 md:text-lg">
                这是一个基于 Next.js、React 19、shadcn/ui 与 Tailwind CSS 4 的现代官网模板。
                它不只负责展示品牌，还把组件体系、自动部署、HTTPS 接入和基础 API 能力一起准备好了。
              </p>
            </div>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-4">
                      ...
                      <div className="mt-4 space-y-3">
                        {["Git push / deploy", "Nginx SSL / active", "PM2 runtime / ready"].map((item) => (
                          <div
                            key={item}
          ...
          <Card className="border-white/10 bg-white/[0.035] backdrop-blur-xl">
            <CardContent className="space-y-6 p-6">
              <div>
                ...
                <h2 className="mt-3 text-3xl font-semibold tracking-[-0.05em] text-white">从组件源码到线上域名，这个项目已经具备完整官网骨架。</h2>
              </div>
              <p className="text-sm leading-7 text-white/60">
                你可以在 `app/` 中扩展页面，在 `components/ui` 中沉淀基础组件，在 `lib/` 中封装请求与工具方法，
                同时继续沿用自动部署与 HTTPS 文档把站点推到线上。
              </p>
            ...
            <CardContent className="grid gap-8 p-8 md:p-12 lg:grid-cols-[1fr_auto] lg:items-end">
              <div className="space-y-5">
                ...
                <p className="max-w-2xl text-base leading-8 text-white/62">
                  接下来只需要把你的品牌文案、页面结构和业务模块继续落进去，就能从“前端工程模板”升级成真正可上线的产品官网。
                </p>
              </div>
